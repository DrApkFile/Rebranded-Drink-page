                ...
                <div className="flex md:flex-row flex-col justify-between md:px-10 px-5 mt-14 md:mt-0">
                        ...
                        <div className="general-title relative flex flex-col justify-center items-center gap-24">
                            ...
                            <div className="nutrition-text-scroll place-self-start">
                                <div className="bg-yellow-brown pb-5 md:pt-0 pt-3 md:px-5 px-3 inline-block">
                                    <h2 className="text-milk-yellow rolling">Mind & Soul</h2>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="flex md:justify-end items-start md:translate-y-20 translate-y-10">
                        <div className="md:max-w-xs w-[70%]">
                            <p className="text-sm md:text-right text-balance font-paragraph para-animate">Nature’s finest fuel, reimagined. A clean blend of essential nutrients, meticulously balanced for high-performance living.</p>
                        </div>
                    </div>
                </div>
