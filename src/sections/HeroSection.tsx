            ...
            <div className="hero-container">
                ...
                <div className="hero-content opacity-0">
                    <div className="overflow-hidden">
                        <h1 className="hero-title lg:p-0 p-2">Simply Unmatched</h1>
                    </div>
                    ...
                    <h2>Elevate your routine with KOZO: A masterclass in smooth texture and vibrant energy that fuels your every move.</h2>
                    <div className="hero-button hover:bg-[#ff85a1]">
                        <a href="#">Experience Excellence</a>
                    </div>
                </div>
            </div>
        </section>
