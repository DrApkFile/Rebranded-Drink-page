            ...
            <div className="container mx-auto flex-center py-28 relative">
                <div className="w-full h-full md:px-30 ">
                    <div className="msg-wrapper">
                        <h1 className="first-message text-wrap w-[90%]">Ignite your inner drive and</h1>
                        <div className="msg-text-scroll md:mt-12 mt-0">
                            <div className="bg-light-brown md:pb-4 pb-3 px-5">
                                <h2 className="text-red-brown">Transform</h2>
                            </div>
                        </div>
                        <h1 className="second-message md:w-full w-[80%]">the essence of KOZO in every satisfying sip.</h1>
                    </div>
                    <div className="flex-center md:mt-20 mt-10">
                        <div className="max-w-md px-10 flex-center overflow-hidden">
                            <p>Step into the exceptional and power your passions with KOZO—designed for those who command the future and cherish the moment.</p>
                        </div>
                    </div>
                </div>
            </div>
