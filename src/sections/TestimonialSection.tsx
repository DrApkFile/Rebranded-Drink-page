                ...
                <div className="pin-box ">
                    {
                        cards.map((card, index) => (
                            ...
                            >
                                ...
                                />
                                <div className="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity flex flex-col justify-center items-center text-white p-4 text-center pointer-events-none">
                                    <p className="font-bold text-lg mb-2">"{card.quote}"</p>
